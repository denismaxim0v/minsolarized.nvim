...
function solarized.getTheme(options)
    ...
    theme.core = {
        ...
        Visual =            { fg = c.base03, bg = c.base02 },
        VisualNOS =         { fg = c.base03, bg = c.base02 },
    ...
    theme.plugins = {
        ...
        LspReferenceText =                     { fg = c.base1, bg = c.base03 },
        LspReferenceRead =                     { fg = c.base1, bg = c.base03 },
        LspReferenceWrite =                    { fg = c.base1, bg = c.base03 },
